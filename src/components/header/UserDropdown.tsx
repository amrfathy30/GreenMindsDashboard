  ...
  return (
    <div className="relative border-y w-full py-2">
      ...
      <Dropdown
        ...
        className="absolute -right-[110%] bottom-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
