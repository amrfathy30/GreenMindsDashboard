              ...
              {initialVideos.map((video, index) => (
                <tr 
                  ...
                  className={`transition-colors ${
                    index % 2 === 0 
                      ? "bg-[rgba(217,217,217,0.25)] dark:bg-white/[0.02]" 
                ...
                >
                  ...
                  <td className="px-6 py-6">
                    <span className="text-xl font-lalezar text-[rgba(0,0,0,1)] dark:text-white leading-none">
                      {video.title}
                    </span>
                  </td>
                  <td className="px-6 py-6 text-center">
                    <div className="flex items-center justify-center">
                      ...
                      <img 
                        src="/images/video-thumb/Stack of Coins.png" 
                        alt="coins" 
                  ...
                  <td className="px-6 py-6 text-center">
                    <span className="text-xl font-lalezar text-gray-700 dark:text-gray-300">
                      {video.age}
                    </span>
                  </td>
                  <td className="px-6 py-6">
