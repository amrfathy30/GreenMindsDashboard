...
const EditGameModal: React.FC<EditGameModalProps> = ({ isOpen, onClose, gameData }) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 backdrop-blur-[1px] p-2 sm:p-4">
      ...
      <div className="relative w-full max-w-3xl rounded-[15px] bg-white shadow-2xl dark:bg-gray-900 overflow-visible mt-10">
        ...
        >
          <h2 className="text-xl sm:text-3xl font-bold text-white tracking-wide truncate">Edit Game</h2>
        </div>
            ...
            <form className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 bg-gray-50/50">
                  <div className="flex h-[70px] w-[90px] shrink-0 items-center justify-center rounded-xl bg-[#C4C4C4] overflow-hidden border border-gray-200 shadow-inner">
                    {previewImage ? (
